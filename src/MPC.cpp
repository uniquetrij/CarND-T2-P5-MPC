...
public:
    ...
    void operator()(ADvector& fg, const ADvector& vars)
    {
        ...
        for (int t = 0; t < N; t++) {
            ...
            // cost for psi error
            fg[0] += 7500 * CppAD::pow(vars[epsi_start + t], 2);
...
//            fg[0] += 0.2 * CppAD::pow(vars[v_start + t] - 200, 2);
//            fg[0] += 0.2 * CppAD::pow(vars[v_start + t] - 180, 2);
        ...
        // cost for too frequent actuation
        for (int t = 0; t < N - 1; t++) {
            // steering
        ...
        // cost for change (sudden) in steering and acceleration
        for (int t = 0; t < N - 2; t++) {
